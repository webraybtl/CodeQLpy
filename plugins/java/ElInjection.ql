...
from DataFlow::PathNode source, DataFlow::PathNode sink, GroovyInjectionConfig conf1, JexlInjectionConfig conf2, MvelInjectionFlowConfig conf3,SpelInjectionConfig conf4,TemplateInjectionFlowConfig conf5
